...
Following, the function shows in the Viewer a plot where is possible observe the chromosomal alteration rate of each chromosomal arms and which one have been selected in the chromosome list (Red bars).
...
```{r echo=FALSE, message=FALSE, paged.print=FALSE, results='asis'}
 library(BOBaFIT)
    data("plot_clust_sample_rep")
    knitr::kable(head(plot_clust_sample_rep))
```
